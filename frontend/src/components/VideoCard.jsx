...
export default function VideoCard({ video, index = 0, onDelete }) {
  ...
  return (
    ...
    >
      ...
      {/* Info Panel */}
      <div className="p-4 bg-surface-1/40 flex flex-col justify-between">
        <div>
        ...
        {/* Action Controls: Download & Delete */}
        <div className="flex items-center justify-between pt-3 border-t border-white/[0.06] mt-1">
          ...
          {onDelete && (
            <button
              ...
              className="bg-rose-500/10 hover:bg-rose-500/25 border border-rose-500/30 text-rose-300 hover:text-white text-[11px] font-extrabold px-2.5 py-1 rounded-lg transition-all flex items-center gap-1"
            >
              <span>🗑️ Delete</span>
            </button>
          )}
